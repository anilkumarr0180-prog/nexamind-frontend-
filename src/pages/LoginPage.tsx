...
export const LoginPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const classified = classifyApiError(err, 'Sign in failed. Please check your credentials and try again.');
      ...
      <div className="w-full max-w-[420px] space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl sm:text-[28px] font-display font-bold tracking-tight text-white">
            Welcome to Nexa<span className="bg-gradient-to-r from-violet-400 via-indigo-300 to-cyan-400 bg-clip-text text-transparent">Mind</span>
          </h1>
          <p className="text-xs sm:text-sm text-slate-400 max-w-xs mx-auto leading-relaxed">
            Sign in to access your persistent cognitive workspace
          </p>
        </div>
